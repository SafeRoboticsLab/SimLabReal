...
# Examples:
    # RA: python3 sim_car_one.py -sf -of scratch -cp 40000 -mu 800000 -g 0.999 -n new-999
...
env.set_costParam(1, -1, 'sparse', targetScaling=args.targetScaling, safetyScaling=1.)
