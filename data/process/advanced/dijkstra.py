...
"""This file is modified from https://github.com/AdaCompNUS/qmdp-net/blob/master/utils/dijkstra.py

# Dijkstra's algorithm for shortest paths# David Eppstein, UC Irvine, 4 April 2002# http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/117228
...
# example, CLR p.528#G = {'s': {'u':10, 'x':5},#	'u': {'v':1, 'x':2},#	'v': {'y':4},#	'x':{'u':3,'v':9,'y':2},#	'y':{'s':7,'v':6}}#print Dijkstra(G,'s')#print shortestPath(G,'s','v')
