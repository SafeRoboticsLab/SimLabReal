...
"""A class for training Recovery RL with frame stacking.
...
class RecoveryRLStack(BaseTrainingStack):
    ...
    def learn(
        ...
        """Learns the Recovery RL with frame stacking.
        ...
        if self.cfg.use_wandb:
            ...
            }, step=self.cnt_step, commit=not self.train_backup)
            if self.train_backup:
                wandb.log({
