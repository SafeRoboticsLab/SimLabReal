...
"""A class for training posterior for Shield with frame stacking.
...
class PolicyPosteriorStackShield(BaseTrainingStack):
    ...
    def learn(
        ...
        """Learns the posterior of Shield with frame stacking.
        ...
        train_progress = [[], [], []]  # perf, shield, step
        violation_record = []
        episode_record = []
        cnt_opt = 0
        cnt_opt_period = 0
        ...
        while self.cnt_step <= max_steps:
            ...
            shield_flag, _ = check_shielding(
                ...
                append, context_backup=None, state=_states,
