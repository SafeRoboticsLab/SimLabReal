...
"""A class for training posterior of PAC-Shield-Perf with frame stacking.
...
Additionally, the two policies have stacked frames as input.
...
class PolicyPosteriorStackPerfLatent(BaseTrainingStack):
    ...
    def learn(
        ...
        """Learns the posterior of PAC-Shield-Perf with frame stacking.
        ...
        while self.cnt_step <= max_steps:
            ...
            if (
                ...
                latent_mean = self.performance.latent_mean.clone().cpu().numpy(
                )
