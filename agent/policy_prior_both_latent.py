...
"""A class for training prior of PAC-Shield-Both.
...
class PolicyPriorBothLatent(BaseTraining):
    ...
    def __init__(
        ...
        if cfg_performance.train.perf_diversity_type == "dynamics":
            self.performance = SAC_dads_prior(
    ...
    def learn(
        ...
        """Learns the prior of PAC-Shield-Both.
        ...
        while self.cnt_step <= max_steps:
            ...
            if apply_shielding:
                shield_flag, _ = check_shielding(
                    ...
                    context_backup=z_backup, state=_prev_states,
            ...
            for env_ind, (s_, r, done, info) in enumerate(
                ...
                self.store_transition(
                    z_perf[env_ind].clone().unsqueeze(0),
            ...
            if (
                ...
                for timer in range(num_update_per_opt):
                    ...
                    batch_backup = self.unpack_batch(
                        batch, get_latent=True, get_latent_backup=True,
