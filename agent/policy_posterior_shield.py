...
"""A class for training posterior for Shield.

This file implements the training of the posterior policy with performance and
...
trained with discounted safety Bellman equation. Unlike the PAC methods where
only the latent distributions are fine-tuned, here the entire networks of the
actor and critic of the two policies are updated.
"""
...
class PolicyPosteriorShield(BaseTraining):
    ...
    def learn(
        ...
        """Learns the posterior of Shield.
        ...
        train_records = [[], []]  # perf, backup
        train_progress = [[], [], [], []]  # perf, backup, shield, step
        violation_record = []
        episode_record = []
        cnt_opt_period = 0
        cnt_opt = 0
